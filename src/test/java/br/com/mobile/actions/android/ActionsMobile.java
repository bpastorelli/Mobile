...
public class ActionsMobile extends PagesController {
	...
	public void removerProdutosCarrinho(String mensagem) {
		...
		do {
			...
			LogReport.passFail(getPage(this.carrinhoPage).textoExibidoPagina("Você excluiu um produto.", 5),
					"Exclusão de produto");
	...
	public void validarProdutoListaFavoritos(String descricao) {
		...
		LogReport.passFail(getPage(this.inicialPage).textoExibidoPagina(descricao, 10),
				"Descricao esperada: " + descricao);
	}
	...
	public void favoritarProdutoNaLista(String descricao) {
		...
		List<MobileElement> elements = getPage(this.pesquisaPage)
